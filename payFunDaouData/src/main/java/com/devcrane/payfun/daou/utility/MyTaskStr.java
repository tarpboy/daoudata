 ...
 */
public abstract class MyTaskStr extends AsyncTask<Void, Integer, String[]> {
     ...
     */
    public MyTaskStr(Activity context) {
        this.context = context;
        execute();
    }
    public MyTaskStr(Activity context, ProgressDialog dialog) {
        this.context = context;
        this.dialog = dialog;
        execute();
    }
